        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 lg:gap-8 mb-16">
          ...
          <div className="lg:col-span-3">
            ...
            <div className="flex space-x-3">
              ...
              <a href="https://www.instagram.com/btwsaifhere" target="_blank" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 transition-all duration-300 hover:bg-[#c13584] hover:border-[#c13584] hover:text-white hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(193,53,132,0.4)]">
                <i className="fab fa-instagram text-sm"></i>
              </a>
              <a target="_blank" href="https://youtube.com/@auramediamarketing?si=QEoe5TaepgICaBdV" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 transition-all duration-300 hover:bg-[#ff0000] hover:border-[#ff0000] hover:text-white hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(255,0,0,0.4)]">
                <i className="fab fa-youtube text-sm"></i>
              </a>
              <a target="_blank" href="https://www.linkedin.com/in/saiffbhaii?utm_source=share_via&utm_content=profile&utm_medium=member_android" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-slate-400 transition-all duration-300 hover:bg-[#0077b5] hover:border-[#0077b5] hover:text-white hover:-translate-y-1 hover:shadow-[0_0_15px_rgba(0,119,181,0.4)]">
